...
//unlink($dir.'/'.$pimage);
	...
	move_uploaded_file($_FILES["pimg2"]["tmp_name"],"products/$pid/".$_FILES["pimg2"]["name"]);
	$sql=mysqli_query($db,"update  products set pimg2='$pimg2' where id='$pid' ");
            ...
            <div class="row p-2 m-1">
                <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                    ...
                    <?php 
											...
											$query=mysqli_query($db,"select pname,pimg2 from products where id='$pid'");
											$cnt=1;
                    ...
                    <div class=" card ">
                        ...
                        <div class="card-header">
                            <img class="border-radius-lg"
                                src="products/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['pimg2']);?>"
                            ...
                            <div class="card-body">
                                ...
                                <input type="file" name="pimg2" id="pimg2" value="" class="input-group input-group-outline" required>
                            </div>
