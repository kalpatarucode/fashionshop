...
//unlink($dir.'/'.$pimage);
	...
	move_uploaded_file($_FILES["pimg1"]["tmp_name"],"products/$pid/".$_FILES["pimg1"]["name"]);
	$sql=mysqli_query($db,"update  products set pimg1='$pimg1' where id='$pid' ");
            ...
            <div class="row p-2 m-1">
                <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                    ...
                    <?php 
											...
											$query=mysqli_query($db,"select pname,pimg1 from products where id='$pid'");
											$cnt=1;
                    ...
                    <div class=" card ">
                        ...
                        <div class="card-header">
                            <img class="border-radius-lg"
                                src="products/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['pimg1']);?>"
                            ...
                            <div class="card-body">
                                ...
                                <input type="file" name="pimg1" id="pimg1" value="" class="input-group input-group-outline" required>
                            </div>
